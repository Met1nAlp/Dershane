...
export default function HomeworkScreen() {
  return (
    <SafeAreaView style={s.safeArea}>
      ...
      <View style={s.header}>
        <Text style={s.headerTitle}>📚 Ödevlerim</Text>
      </View>

      <View style={s.bosContainer}>
        <Text style={{ fontSize: 56 }}>🚧</Text>
        <Text style={s.bosTitle}>Ödev Sistemi Yapım Aşamasında</Text>
        <Text style={s.bosText}>Bu özellik yakında aktif olacaktır.</Text>
      </View>
